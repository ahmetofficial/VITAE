...
import com.project.ui.seach.adapter.DoctorSearchAdapter;
...
public class FragmentDoctorSearch extends Fragment {
    ...
    public FragmentDoctorSearch(String visitorUserId, String query) {
        this.query = query;
    ...
    public void listSearchResult(final String visitorUserId,String query) {
        try {
            ...
            ApiClient.doctorApi().searchDoctor( fullTextSearchRequest ).enqueue( new Callback<User>() {
                @Override
                public void onResponse(Call<User> call, Response<User> response) {
                    if (response.isSuccessful()) {
                        ...
                        if(userSearchList.size()==0){
                            ...
                            mAdapter = new DoctorSearchAdapter( userSearchList, getContext(), visitorUserId );
