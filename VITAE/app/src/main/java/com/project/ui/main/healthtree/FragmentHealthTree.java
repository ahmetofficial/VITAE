...
package com.project.ui.main.healthtree;
...
import com.project.ui.main.healthtree.disease.DiseaseAddActivity;
import com.project.ui.main.healthtree.disease.DiseaseDrugFragment;
import com.project.ui.main.healthtree.disease.DiseaseTreatmentFragment;
...
public class FragmentHealthTree extends Fragment {
    ...
    public int getTotalHealthItemCount() {
        if (!diseaseCellUserDiseaseCount.getText().toString().isEmpty()
                && !treatmentCellUserTreatmentCount.getText().toString().isEmpty()
                && !drugCellUseraDrugUsageCount.getText().toString().isEmpty()) {
